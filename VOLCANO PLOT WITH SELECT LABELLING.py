# -*- coding: utf-8 -*-
"""
Created on Tue Aug 13 18:29:42 2024
...
genes_to_label = [
    "JUNB", "TXN", "PRDX1", "PRDX2", "IPCEF1", "TXNRD1", "MSRA", "GSR", "ABCC1", "GCLC", "SBNO2"
]

# Add labels to the specified genes, ensuring they don't overlap
texts = []
...
plt.title('Volcano Plot of Differential ROS Gene Expression: Glioblastoma vs PBMC')
